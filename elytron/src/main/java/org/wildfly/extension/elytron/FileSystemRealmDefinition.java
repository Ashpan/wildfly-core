...
class FileSystemRealmDefinition extends SimpleResourceDefinition {
    ...
    private static class RealmAddHandler extends BaseAddHandler {
        ...
        private SecretKey getSecretKey(OperationContext context, String credentialStoreReference, String alias) throws OperationFailedException {
        ...
        private char[] getKeyStorePassword(KeyStoreService keyStoreService) throws RuntimeException {
        ...
        protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model)
            ...
            if (credentialStore != null) {
                credentialStoreRuntimeCapability = buildDynamicCapabilityName(CREDENTIAL_STORE_CAPABILITY, credentialStore);
            ...
            String keyStoreRuntimeCapability;
